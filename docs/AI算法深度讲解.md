...
> 维护说明：本文是 AI 结构和算法的长篇参考。最新接口、棋盘尺寸、8x8 支持和非法着法修复状态，以 [当前实现状态](当前实现状态.md) 与 [2026-04-22：竞技化 8x8 与 AI 修复](2026-04-22-竞技化8x8与AI修复.md) 为准。
...
14. [2026-04-21 实现同步](#14-2026-04-21-实现同步)
...
2026-04-21 后，AI 已经支持飞子基础走法和竞技化走法过滤。按照最新规则 PDF，后续还应补充成阵型吃、吉祥阵型，以及传统固定棋形胜负规则。
...
2. 建立统一的阵型识别模块，把褡裢、双门褡裢、拉萨等基本阵型转化为可搜索事件。
3. 再逐步把枪、煞、岚、三叉黑铁、恰、颂然，以及“十字飞子久”“九子五久飞子久”纳入收益评估。
4. 建立固定局面回归样例，验证飞子、连跳、成方补吃和竞技化约束不会回退。

### 13.4 文档配套关系

如果要结合规则与实现一起阅读，建议同时参考：

- [藏久棋规则整理.md](/C:/Users/林/Desktop/实验文档/论文1/work/docs/藏久棋规则整理.md)
- [项目分析-藏族久棋.md](/C:/Users/林/Desktop/实验文档/论文1/work/docs/项目分析-藏族久棋.md)
- [藏久棋全阶段实现规划.md](/C:/Users/林/Desktop/实验文档/论文1/work/docs/藏久棋全阶段实现规划.md)
- [变更记录.md](/C:/Users/林/Desktop/实验文档/论文1/work/docs/变更记录.md)
